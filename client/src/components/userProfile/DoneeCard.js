        ...
        <CardContent>
          <CardActionArea onClick={this.handleDoneeClick}>
            <img
              ...
              alt="Donee"
              src={
                this.props.donee.profilePicture === undefined
                  ...
                  : this.props.donee.profilePicture
              }
            />
          ...
          <Typography variant="body2">
            $
            {this.props.donee.funded === undefined
              ? "0"
              : this.props.donee.funded}{" "}
            funded of $
            {this.props.donee.monthlyDonationLimit === undefined
              ? "1500"
          ...
          <Typography variant="subtitle1">
            Until{" "}
            {this.props.donee.monthlyRenewalDate === undefined
              ? "10/06/2019"
              : this.props.donee.monthlyRenewalDate}
          </Typography>
